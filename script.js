...
let palavras = [
        ...
        ['cabelo', 'tem vários tipos de corte'],
        ['guitarra', 'instrumento de cordas'],
        ['bisavô', 'o neto dele é seu pai'],
        ['biblioteca', 'lugar de leitura'],
        ['cavalo', 'cavaleiros precisam dele'],
        ['lavanderia', 'lugar de lavar roupas'],
        ['aliança', 'tem no casamento'],
        ['palhaço', 'tem no circo'],
        ['ônibus', 'tipo de transporte'],
...
btnComecar.addEventListener('click', () => {
   ...
   nomePlayer1.innerHTML = nome1.value
   nomePlayer2.innerHTML = nome2.value
})
...
function telaFinal() {
  ...
  if(rodada === 1) {
    vencedor.innerHTML = `${nome1.value} venceu!`
    pontosVencedor.innerHTML = 'O premio foi ' + pontosJogador1
  } 
  if(rodada === 2) {
    vencedor.innerHTML = `${nome2.value} venceu!`
